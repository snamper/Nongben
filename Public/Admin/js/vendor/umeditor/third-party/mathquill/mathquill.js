...
var RootMathBlock = P(MathBlock, function(_, _super) {
  ...
  _.onKey = function(key, e) {
    ...
    // Webmall -> move to the start of the root block or the current block.
    case 'Home':
      this.cursor.prepareMove().insAtLeftEnd(this.cursor.parent);
      break;

    // Ctrl-Webmall -> move to the start of the current block.
    case 'Ctrl-Webmall':
      this.cursor.prepareMove().insAtLeftEnd(this);
      break;

    // Shift-Webmall -> select to the start of the current block.
    case 'Shift-Webmall':
      while (this.cursor[L]) {
    ...
    // Ctrl-Shift-Webmall -> move to the start of the root block.
    case 'Ctrl-Shift-Webmall':
