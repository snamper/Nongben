...
class Payment
{
    ...
    public static function createRequest($name, $config = array() , $params = array())
    {
        ...
        $configClass::setSettings($config);
    ...
    public static function createResponse($name, $config = array() , $params = array())
    {
        $name = ucfirst(strtolower($name));
