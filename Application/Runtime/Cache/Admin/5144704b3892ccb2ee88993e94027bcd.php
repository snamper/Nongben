    ...
    <div class="col-md-8">
        <div class="panel panel-default">
            <div class="panel-body">
                <form class="form-horizontal J_validateForm J_ajaxForm demoform" action="<?php echo U('advertisement/do_edit');?>" method="post">
                    <fieldset>
                        <input type="hidden" name="id" value="<?php echo ($advertisement["id"]); ?>">
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="title">标题</label>
                            <div class="col-md-9">
                                <input id="title" name="title" type="text" placeholder="标题，不超过50个字" class="form-control" datatype="*1-50" errormsg="标题不能超过50个字" value="<?php echo ($advertisement["title"]); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input id="author" name="url" type="text" placeholder="链接url，可留空" class="form-control" datatype="url|n0-0" errormsg="请填写正确的url" value="<?php echo ($advertisement["url"]); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input id="sort" name="sort" type="text" placeholder="默认为1" class="form-control" datatype="n0-100" errormsg="填写错误" value="<?php echo ($advertisement["sort"]); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <div class="control-group">
                                    <div class="controls">
                                        <input type="hidden" name="image" datatype="*" nullmsg="请上传图片" value="<?php echo ($advertisement["image"]); ?>"><!--接收上传成功后的数据表img的id-->
                                        <img src='<?php echo ($advertisement["img_path"]); ?>' style='height: 120px;width: 120px;padding-bottom: 10px;'>
