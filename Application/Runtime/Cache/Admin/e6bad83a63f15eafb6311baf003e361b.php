    ...
    <div class="col-md-8">
        <div class="panel panel-default">
            <div class="panel-body">
                <form class="form-horizontal J_validateForm J_ajaxForm demoform" action="<?php echo U('info/do_edit');?>" method="post">
                    <fieldset>
                        <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="title">标题</label>
                            <div class="col-md-9">
                                <input id="title" name="title" type="text" placeholder="标题，不超过50个字" class="form-control" datatype="*1-50" errormsg="标题不能超过50个字" value="<?php echo ($info["title"]); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input id="author" name="author" type="text" placeholder="作者，不超过20个字" class="form-control" datatype="s1-20" errormsg="作者不能超过20个字" value="<?php echo ($info["author"]); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input id="sort" name="sort" type="text" placeholder="默认为1" class="form-control" datatype="n0-10000" errormsg="填写错误" value="<?php echo ($info["sort"]); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <div class="control-group">
                                    <div class="controls">
                                        <input type="hidden" name="logo" datatype="*" nullmsg="请上传图片" value="<?php echo ($info["logo"]); ?>"><!--接收上传成功后的数据表img的id-->
                                        <img src='<?php echo ($info["img_path"]); ?>' style='height: 120px;width: 120px;padding-bottom: 10px;'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <script id="container" name="content" type="text/plain" style="width:819.75px;height:240px;"><?php echo (htmlspecialchars_decode($info["content"])); ?></script>
                            </div>
                        </div>
