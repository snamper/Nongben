...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">溯源产品添加</h1>
    </div>
</div><!--/.row-->
<div class="row">
<div class="col-md-8">
<div class="panel panel-default">
            <div class="panel-body">
                <form class="form-horizontal J_validateForm J_ajaxForm demoform" action="<?php echo U('source/do_add');?>" method="post">
                    <fieldset>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="name">产品名称</label>
                            <div class="col-md-9">
                                <input id="name" name="name" type="text" placeholder="产品名称，不超过10个字" class="form-control" datatype="s1-10" errormsg="产品名称不能超过10个字" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input id="author" name="source" type="text" placeholder="来源地，不超过10个字" class="form-control" datatype="*1-10" errormsg="来源地不能超过10个字">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <div class="control-group">
                                    <div class="controls">
                                        <input type="hidden" name="code" datatype="*" nullmsg="请上传二维码" value=""><!--接收上传成功后的数据表img的id-->
                                        <input type="file" id="wx-code"><!--上传点击按钮-->
                                    </div>
                                </div>
                            </div>
                        </div>
