...
<div class="panel panel-default">
            <div class="panel-body">
                <form class="form-horizontal J_validateForm J_ajaxForm demoform" action="<?php echo U('course/do_add');?>" method="post">
                    <fieldset>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="title">课程名称</label>
                            <div class="col-md-9">
                                <input id="title" name="name" type="text" placeholder="课程名称，不超过50个字" class="form-control" datatype="*1-50" errormsg="课程名称不能超过50个字" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea id="description" name="description" datatype="*1-1000" placeholder="课程简介，不超过1000个字" class="form-control" errormsg="课程简介不能超过1000个字"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input id="teacher" name="teacher" type="text" placeholder="课程讲师，不超过20个字" class="form-control" datatype="*1-20" errormsg="课程讲师不能超过20个字" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="hidden" id="category_id" name="category_id" datatype="*" nullmsg="请选择课程分类" value="">
                                <table>
                                    <tr>
                                        <td>
                                            <select id="first" class="J_ajax_select length_4 form-control" data-init="true" data-val="category_id" data-url="<?php echo U('category/get_category_list');?>" data-target="second">
                                                <option value="">请选择</option>
                                            </select>
                                        </td>
                                        <td>
                                            <select id="second" class="J_ajax_select length_4 form-control" data-val="category_id" data-target="third" data-url="<?php echo U('category/get_category_list');?>">
                                            <option value="">请选择</option>
                                            </select>
                                        </td>
                                        <td>
                                            <select id="third" class="J_ajax_select length_4 form-control" data-val="category_id" data-url="<?php echo U('category/get_category_list');?>">
                                                <option value="">请选择</option>
                                            </select>
                                        </td>
                                    </tr>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <div class="control-group">
                                    <div class="controls">
                                        <input type="hidden" name="video" datatype="*" nullmsg="请上传视频" value=""><!--接收上传成功后的数据表img的id-->
