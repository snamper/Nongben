			...
			<menu class="u-m-left">
				...
				<section class="uMenuFixed">
					...
					<div class="u-menu-list">
						...
						<dl id="leftdl_sns">
							<dt class="curr"><em class="icon-2-18 u-m-icon-6">&nbsp;</em><span class="c-333 ml10 fsize16 vam">我的消息</span><em class="icon-2-14 u-up-down ml15">&nbsp;</em></dt>
							<dd style="display: block;">
								<ol>
									<li>
										<a class="c-blue" href="msg_sys.html" title="我的消息">我的消息</a>
									</li>
								</ol>
							</dd>
						</dl>
					...
					<section class="u-m-c-wrap">
						<section class="u-m-c-head">
							<ul class="fl u-m-c-h-txt">
								<li class="current">
									<a href="javascript:void(0)" title="">我的消息</a>
								</li>
							</ul>
							<div class="clear"></div>
						</section>
										...
										<ul class="u-sys-message">
													...
													<tbody>
														<tr>
															<td width="25%" valign="top">
																...
																<p class="mt5"><tt class="c-999">发送于：<?php echo ($user["gmt_create"]); ?></tt></p>
															</td>
															<td width="70%" valign="top" class="u-s-m-desc">
																<div class="mt5">
																	<p class="c-666 fsize14" style="line-height: 180%"> 欢迎来到宁波农本，跟我学在线教育平台，希望您能够快乐的学习!</p>
																</div>
															</td>
															<td width="5%" align="center">
																<a class="u-address-delete" href="javascript:void(0)" onclick="delULetter(2262)" title="删除"><em class="icon-2-14">&nbsp;</em></a>
															</td>
														</tr>
													</tbody>
												</table>
											...
											<li>
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													...
													<tr>
														<td width="25%" valign="top">
															<p class="hLh20 of"><tt class="c-red">yolanda</tt></p>
															<p class="mt5"><tt class="c-999">发送于：<?php echo ($user["gmt_login"]); ?></tt></p>
														</td>
														<td width="70%" valign="top" class="u-s-m-desc">
															<div class="mt5">
																<p class="c-666 fsize14" style="line-height: 180%">这个老师讲的不错</p>
															</div>
														</td>
														<td width="5%" align="center">
															<a class="u-address-delete" href="javascript:void(0)" onclick="delULetter(2262)" title="删除"><em class="icon-2-14">&nbsp;</em></a>
